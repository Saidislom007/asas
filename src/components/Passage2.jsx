...
const Passage2 = ({ onSubmit, fontSize }) => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/reading-tests/1/passage/2`)
      .then((res) => {
        setPassage(res.data);
        setLoading(false);
      })
      ...
      <div className="reading-test-wrapper">
        <div className="header">
          <div className="header-content">
            ...
            <div className="header-info">Passage 2</div>
          </div>
        </div>
        ...
        <div className="main-content">
          ...
          <div className="passage-section">
            <div className="passage-header">
              <div className="passage-badge">Passage 2</div>
